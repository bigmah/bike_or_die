...
/* Where a chunk keeps the 68k registers while it runs: in locals natively,
 * and with RECOMP_MEMREGS in the state they came from, which is what the
 * WebAssembly build wants. tools/recomparm.py says why. */
